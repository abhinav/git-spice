...
type Options struct {
	...
	Fill   bool `short:"c" negatable:"" config:"message.autoFill" help:"Fill in the change title and body via the configured message generator. Defaults to spice.message.autoFill."`
