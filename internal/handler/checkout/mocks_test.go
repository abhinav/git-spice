...
// Source: go.abhg.dev/gs/internal/handler/checkout (interfaces: GitRepository,GitWorktree,TrackHandler,Service,Store,SubmoduleApplier)
//
// Generated by this command:
//
//	mockgen -destination mocks_test.go -package checkout -typed . GitRepository,GitWorktree,TrackHandler,Service,Store,SubmoduleApplier
//
...
// RestoreHead mocks base method.
func (m *MockGitWorktree) RestoreHead(ctx context.Context, snap *git.HeadSnapshot) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RestoreHead", ctx, snap)
	ret0, _ := ret[0].(error)
	return ret0
}

// RestoreHead indicates an expected call of RestoreHead.
func (mr *MockGitWorktreeMockRecorder) RestoreHead(ctx, snap any) *MockGitWorktreeRestoreHeadCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RestoreHead", reflect.TypeOf((*MockGitWorktree)(nil).RestoreHead), ctx, snap)
	return &MockGitWorktreeRestoreHeadCall{Call: call}
}

// MockGitWorktreeRestoreHeadCall wrap *gomock.Call
type MockGitWorktreeRestoreHeadCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockGitWorktreeRestoreHeadCall) Return(arg0 error) *MockGitWorktreeRestoreHeadCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockGitWorktreeRestoreHeadCall) Do(f func(context.Context, *git.HeadSnapshot) error) *MockGitWorktreeRestoreHeadCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockGitWorktreeRestoreHeadCall) DoAndReturn(f func(context.Context, *git.HeadSnapshot) error) *MockGitWorktreeRestoreHeadCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}

// SnapshotHead mocks base method.
func (m *MockGitWorktree) SnapshotHead(ctx context.Context) (*git.HeadSnapshot, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SnapshotHead", ctx)
	ret0, _ := ret[0].(*git.HeadSnapshot)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// SnapshotHead indicates an expected call of SnapshotHead.
func (mr *MockGitWorktreeMockRecorder) SnapshotHead(ctx any) *MockGitWorktreeSnapshotHeadCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SnapshotHead", reflect.TypeOf((*MockGitWorktree)(nil).SnapshotHead), ctx)
	return &MockGitWorktreeSnapshotHeadCall{Call: call}
}

// MockGitWorktreeSnapshotHeadCall wrap *gomock.Call
type MockGitWorktreeSnapshotHeadCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockGitWorktreeSnapshotHeadCall) Return(arg0 *git.HeadSnapshot, arg1 error) *MockGitWorktreeSnapshotHeadCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockGitWorktreeSnapshotHeadCall) Do(f func(context.Context) (*git.HeadSnapshot, error)) *MockGitWorktreeSnapshotHeadCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockGitWorktreeSnapshotHeadCall) DoAndReturn(f func(context.Context) (*git.HeadSnapshot, error)) *MockGitWorktreeSnapshotHeadCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
// MockSubmoduleApplier is a mock of SubmoduleApplier interface.
type MockSubmoduleApplier struct {
	ctrl     *gomock.Controller
	recorder *MockSubmoduleApplierMockRecorder
	isgomock struct{}
}

// MockSubmoduleApplierMockRecorder is the mock recorder for MockSubmoduleApplier.
type MockSubmoduleApplierMockRecorder struct {
	mock *MockSubmoduleApplier
}

// NewMockSubmoduleApplier creates a new mock instance.
func NewMockSubmoduleApplier(ctrl *gomock.Controller) *MockSubmoduleApplier {
	mock := &MockSubmoduleApplier{ctrl: ctrl}
	mock.recorder = &MockSubmoduleApplierMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockSubmoduleApplier) EXPECT() *MockSubmoduleApplierMockRecorder {
	return m.recorder
}

// ApplyAssociations mocks base method.
func (m *MockSubmoduleApplier) ApplyAssociations(ctx context.Context, parentBranch string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ApplyAssociations", ctx, parentBranch)
	ret0, _ := ret[0].(error)
	return ret0
}

// ApplyAssociations indicates an expected call of ApplyAssociations.
func (mr *MockSubmoduleApplierMockRecorder) ApplyAssociations(ctx, parentBranch any) *MockSubmoduleApplierApplyAssociationsCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ApplyAssociations", reflect.TypeOf((*MockSubmoduleApplier)(nil).ApplyAssociations), ctx, parentBranch)
	return &MockSubmoduleApplierApplyAssociationsCall{Call: call}
}

// MockSubmoduleApplierApplyAssociationsCall wrap *gomock.Call
type MockSubmoduleApplierApplyAssociationsCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockSubmoduleApplierApplyAssociationsCall) Return(arg0 error) *MockSubmoduleApplierApplyAssociationsCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockSubmoduleApplierApplyAssociationsCall) Do(f func(context.Context, string) error) *MockSubmoduleApplierApplyAssociationsCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockSubmoduleApplierApplyAssociationsCall) DoAndReturn(f func(context.Context, string) error) *MockSubmoduleApplierApplyAssociationsCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
