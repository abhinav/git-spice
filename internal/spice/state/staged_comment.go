...
type StagedComment struct {
	// LocalID is a local auto-increment identifier
	...
	Lines forge.InlineCommentRange `json:"lines"`

	// Body is the markdown body of the comment.
	Body string `json:"body"`

	// ID is set when replying to an existing inline comment thread.
	ID forge.InlineCommentThreadID `json:"id,omitempty"`
}
