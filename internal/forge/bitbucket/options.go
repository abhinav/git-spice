...
type Options struct {
	...
	URL string `name:"bitbucket-url" hidden:"" config:"forge.bitbucket.url" env:"BITBUCKET_URL" help:"Bitbucket web URL"`

	// APIURL is the URL for Bitbucket's API.
	// Override this for testing or self-hosted Bitbucket instances.
	APIURL string `name:"bitbucket-api-url" hidden:"" config:"forge.bitbucket.apiURL" env:"BITBUCKET_API_URL" help:"API"`
