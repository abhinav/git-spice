...
func TestRollupFromStatusCheckRollupState(t *testing.T) {
	tests := []struct {
		...
		{"SUCCESS", forge.ChecksRollupPassed},
		{"PENDING", forge.ChecksRollupPending},
		{"EXPECTED", forge.ChecksRollupPending},
		{"FAILURE", forge.ChecksRollupFailed},
		{"ERROR", forge.ChecksRollupFailed},
		{"", forge.ChecksRollupNone},
		{"unknown", forge.ChecksRollupFailed},
	}
