...
// Source: go.abhg.dev/gs/internal/forge (interfaces: Forge,ChangeID,RepositoryID,Repository)
//
// Generated by this command:
//
//	mockgen -destination=forgetest/mocks.go -package forgetest -typed . Forge,ChangeID,RepositoryID,Repository
//
