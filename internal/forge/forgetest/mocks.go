...
func (m *MockRepository) ChecksByChange(ctx context.Context, ids []forge.ChangeID) ([]*forge.ChecksReport, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ChecksByChange", ctx, ids)
	ret0, _ := ret[0].([]*forge.ChecksReport)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// Return rewrite *gomock.Call.Return
func (c *MockRepositoryChecksByChangeCall) Return(arg0 []*forge.ChecksReport, arg1 error) *MockRepositoryChecksByChangeCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockRepositoryChecksByChangeCall) Do(f func(context.Context, []forge.ChangeID) ([]*forge.ChecksReport, error)) *MockRepositoryChecksByChangeCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockRepositoryChecksByChangeCall) DoAndReturn(f func(context.Context, []forge.ChangeID) ([]*forge.ChecksReport, error)) *MockRepositoryChecksByChangeCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
