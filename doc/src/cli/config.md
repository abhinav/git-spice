...
### spice.branchCreate.restack

<!-- gs:version unreleased -->

Controls whether $$gs branch create$$ automatically restacks upstack branches
when using `--insert` or `--below`.

**Accepted values:**

- `upstack` (default): restack the affected upstack branches
- `none`: leave the affected upstack branches for later restacking

### spice.branchEdit.restack

<!-- gs:version unreleased -->

Controls whether $$gs branch edit$$ automatically restacks upstack branches
after editing the current branch's commits.
...
### spice.branchSquash.restack

<!-- gs:version unreleased -->

Controls whether $$gs branch squash$$ automatically restacks upstack branches
after squashing the current branch.
...
### spice.commitAmend.restack

<!-- gs:version unreleased -->

Controls whether $$gs commit amend$$ automatically restacks upstack branches
after amending the current branch.
...
### spice.commitCreate.restack

<!-- gs:version unreleased -->

Controls whether $$gs commit create$$ automatically restacks upstack branches
after creating a commit on the current branch.
...
### spice.commitFixup.restack

<!-- gs:version unreleased -->

Controls whether $$gs commit fixup$$ automatically restacks upstack branches
after applying changes to a downstack commit.
...
### spice.commitPick.restack

<!-- gs:version unreleased -->

Controls whether $$gs commit pick$$ automatically restacks upstack branches
after applying the selected commit.
...
### spice.commitSplit.restack

<!-- gs:version unreleased -->

Controls whether $$gs commit split$$ automatically restacks upstack branches
after splitting the current commit.
