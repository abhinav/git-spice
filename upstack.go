...
type upstackCmd struct {
	...
	Sync    upstackSyncCmd    `cmd:"" aliases:"sy" help:"Pull remote-side commits for a branch and those above it" released:"unreleased"`
	...
	Delete  upstackDeleteCmd  `cmd:"" aliases:"d" released:"v0.16.0" help:"Delete all branches above the current branch"`
}
